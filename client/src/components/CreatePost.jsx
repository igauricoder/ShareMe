  ...
  return (
    <div className="w-full h-auto flex items-center justify-start flex-col gap-4 ">
      ...
      <input type="text"
       ...
       shadow-inner text-lg text-primary font-semibold"
       value={title}
       ...
       >
        {categoriesList && categoriesList.map(value =>(
          <SwiperSlide key={value.id} className="py-4">
            <div
            className={`px-2 py-1 flex item-center justify-center rounded-md border border-gray-200 hover:shadow-md
            shadow-inner ${
      ...
      {/* file upload*/}
      <div className="w-full bg-gray-100 backdrop-blur-md h-370 rounded-md border-2 border-dotted
     ...
     {asset && (
          <div
            className="w-12 h-12 rounded-full flex items-center justify-center bg-red-400 hover:bg-red-600
            cursor-pointer absolute top-5 right-5"
      ...
      <textarea
        ...
        className="w-full px-4 py-3  rounded-md border border-gray-200 shadow-inner text-lg
